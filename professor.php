		...
		<div id="main-container">
			...
			<div id="main-content">
					...
					<div class="container">
						<div class="widget kopa-widget-breadcrumb">
							<div class="widget-content">
								<h3 class="breadcrumb-title">Professor list</h3>
								<div class="breadcrumb-nav">
									...
									<span class="current-page">Professor list</span>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="kopa-area">
					<div class="container">
						<div class="widget kopa-widget-list_teachers">
							<div class="widget-content module-list_teachers-02">
								<div class="row">
